...
// IMAGES
import bucketlist from '../images/bucket-list.png'
import gourmetgossip from '../images/gourmet-gossip.png'
          ...
          <Tabs
            ...
            >
              ...
              <Row className='container-projects'>
                  ...
                  <Col>
                    <p>A recipe sharing application based on a <strong>React front-end</strong>, <strong>Node back-end</strong>, a fully functional <strong>Express API with CRUD functionality</strong> and custom authentication for login and register.</p>
